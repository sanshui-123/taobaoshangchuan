...
export const step5: StepHandler = async (ctx) => {
  ctx.logger.info('Step 5 placeholder: 上传1:1主图');
  await new Promise(resolve => setTimeout(resolve, 100));
};

// 步骤6：宝贝标题-商品分类
export const step6: StepHandler = async (ctx) => {
  ctx.logger.info('Step 6 placeholder: 宝贝标题-商品分类');
  await new Promise(resolve => setTimeout(resolve, 100));
};

// 步骤7：品牌上传
export const step7: StepHandler = async (ctx) => {
  ctx.logger.info('Step 7 placeholder: 品牌上传');
  await new Promise(resolve => setTimeout(resolve, 100));
};

// 步骤8：货号、适用对象
export const step8: StepHandler = async (ctx) => {
  ctx.logger.info('Step 8 placeholder: 货号、适用对象');
  await new Promise(resolve => setTimeout(resolve, 100));
};

// 步骤9：颜色填写
export const step9: StepHandler = async (ctx) => {
  ctx.logger.info('Step 9 placeholder: 颜色填写');
  await new Promise(resolve => setTimeout(resolve, 100));
};

// 步骤10：尺码
export const step10: StepHandler = async (ctx) => {
  ctx.logger.info('Step 10 placeholder: 尺码');
  await new Promise(resolve => setTimeout(resolve, 100));
};

// 步骤11：价格和商品id
export const step11: StepHandler = async (ctx) => {
  ctx.logger.info('Step 11 placeholder: 价格和商品id');
  await new Promise(resolve => setTimeout(resolve, 100));
};

// 步骤12：3:4主图
export const step12: StepHandler = async (ctx) => {
  ctx.logger.info('Step 12 placeholder: 3:4主图');
  await new Promise(resolve => setTimeout(resolve, 100));
};

// 步骤13：模版处理
export const step13: StepHandler = async (ctx) => {
  ctx.logger.info('Step 13 placeholder: 模版处理');
  await new Promise(resolve => setTimeout(resolve, 100));
};

// 步骤14：最后一步
export const step14: StepHandler = async (ctx) => {
  ctx.logger.info('Step 14 placeholder: 最后一步');
  await new Promise(resolve => setTimeout(resolve, 100));
};

// 步骤15：提交商品
export const step15: StepHandler = async (ctx) => {
  ctx.logger.info('Step 15 placeholder: 提交商品');
  await new Promise(resolve => setTimeout(resolve, 100));
};
...
export const steps: Record<StepId, StepHandler> = {
  ...
  4: step4,
  5: step5,
  6: step6,   // 新增：宝贝标题-商品分类
  7: step7,   // 原 step6：品牌上传
  8: step8,   // 原 step7：货号、适用对象
